...
v0.8 已加入真正的 WorldX Phaser 图形世界：library/worlds/world_xiuxian_wanjie/。它包含 2752×1536 可行走背景、碰撞网格、区域锚点、交互物与六名动画角色，不再只是文字面板。

在世界选择页载入 **万劫问仙·青云坊市**，即可进入青石主街、丹符阁、天机台和问剑碑。默认主角是陆尘；也可以在问道面板选择任意世界角色“以此身入局”。
...
- React 游戏面板：选主角、章节目标、修炼、突破、意外选择和联机房间
